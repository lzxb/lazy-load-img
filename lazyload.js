...
!(function (Lazyload) {
     ...
     * 创建插件所需样式
     */
    Lazyload.prototype.createStyle = function () {
        var style = document.getElementById('lazyload-style');
        if (style) {
            return false; //已经创建了样式
        }
        style = document.createElement('style');
        style.id = 'lazyload-style';
        style.type = 'text/css';
        style.innerHTML = '\
            .lazyload-qriginal {\
     ...
     * 遍历DOM元素
     */
    Lazyload.prototype.eachDOM = function () {
     ...
     */
    Lazyload.prototype.testMeet = function (el) {
     ...
     */
    Lazyload.prototype.loadImg = function (el) {
        var _this = this;
        ...
        img.addEventListener('load', function () {
            ...
            if (_this.qriginal) {
                ...
                el.className += ' lazyload-qriginal';
